...
| [**ISSUE-026**](09-stnb-evaluation-capabilities/README.md#resolved-issues) | STNB Ground-Truth Data Absence & Missing CPM Pilot Corpus | 09-STNB Capabilities | `episteme-pipeline` | Horizon 1 | Critical | `Resolved` |
| [**ISSUE-027**](09-stnb-evaluation-capabilities/README.md#resolved-issues) | STNB JSON-LD Adapter Schema Inconsistencies & Edge Decoding Bugs | 09-STNB Capabilities | `episteme-pipeline` | Horizon 1 | Critical | `Resolved` |
| [**ISSUE-028**](09-stnb-evaluation-capabilities/README.md#resolved-issues) | Evaluation Packaging Consolidation & In-Memory TheoryNet Execution | 09-STNB Capabilities | `episteme-pipeline` | Horizon 1 | Critical | `Resolved` |
| [**ISSUE-029**](09-stnb-evaluation-capabilities/README.md#resolved-issues) | Missing `TheoryGraph` Domain Architecture & Broken Contract in `epistemetrics` | 09-STNB Capabilities | `epistemetrics` / `episteme-pipeline` | Horizon 1 | Critical | `Resolved` |
| [**ISSUE-030**](09-stnb-evaluation-capabilities/README.md#resolved-issues) | Comprehensive Intrinsic Evaluation: Model Component Decomposition & Full Property Subsumption | 09-STNB Capabilities | `epistemetrics` / `episteme-pipeline` | Horizon 1 | Critical | `Resolved` |
